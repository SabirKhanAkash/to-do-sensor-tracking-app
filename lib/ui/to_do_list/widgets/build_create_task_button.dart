...
GestureDetector buildCreateTaskButton(BuildContext context, TextEditingController taskController,
    TextEditingController listTitleController, int dataId) {
  return GestureDetector(
    onTap: () => buildTaskEntryUI(context, taskController, listTitleController, dataId),
